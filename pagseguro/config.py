...
class Config(dict):
    def __init__(self, **kwargs):
        ...
        defaults = dict(
            PRE_APPROVAL_SUBS_URL='{}/pre-approvals'.format(base_url, version),
            PRE_APPROVAL_PAYMENT_URL='{}{}pre-approvals/payment'.format(base_url, version),
            PRE_APPROVAL_PLAN_URL='{}{}pre-approvals/request'.format(base_url, version),
            PRE_APPROVAL_CANCEL_URL='{}/pre-approvals/%s/status'.format(base_url),
            ...
            PRE_APPROVAL_NOTIFICATION_URL='{}{}'.format(base_url, pre_approval_notification_suffix),
            ...
            PAYMENT_URL='{}{}/payment.html?code=%s'.format(payment_host, checkout_suffix),
